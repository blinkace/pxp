...
class XBRLJSONReportParser:
    ...
    def parse(self, url):
        ...
        if type(docType) != str or docType not in {DocumentType.xbrljson_git, DocumentType.xbrljson_wgwd, DocumentType.xbrljson_cr7, DocumentType.xbrljson_cr9, DocumentType.xbrljson_pr1, DocumentType.xbrljson}:
